...
export default function WinterCedarHearthPage() {
  return (
    <main className="max-w-4xl mx-auto px-6 py-12 bg-[#F5F0E9]">
      <h1 className="text-5xl font-serif font-bold mb-6">Winter Cedar Hearth</h1>
      ...
      <p className="text-lg mb-6">
        Winter Cedar Hearth blends rich cedarwood with winter spice, dried
        citrus, and soft smoke essential oils for a clean, warm, seasonal scent.
      </p>
      ...
      <div className="bg-white p-6 rounded-xl shadow-md border mb-10">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            onClick={() =>
              handleBuy("price_1Sa4mV8eVpOw1nOMgplbRvTY")
            }
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={() =>
              handleBuy("price_1Sa4mo8eVpOw1nOMQdgenWxX")
            }
            className="px-5 py-2 bg-black text-white rounded-lg hover:bg-gray-800 transition"
          >
            Buy 6-Pack
      ...
      <ul className="list-disc ml-6 text-lg space-y-1 mb-10">
        ...
        <li>Fireplace essential oil</li>
        <li>Winter spice oils</li>
      </ul>
    </main>
  );
}
